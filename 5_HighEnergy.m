...
Decompose\[Lambda]to\[Chi][legs_:AllMassiveLegs[]][expr_]:=expr//.{
...
(* ::Input::Initialization:: *)
DecomposetoSU2Basis[legs_:AllMassiveLegs[]][expr_]:=expr//.{
...
HighEnergyLimit[Mslegs_List(*leg before High energy*),Mllegs_List(*Massless leg after high energy*)][expr_]:=Module[{sublegs},sublegs=Thread[Mslegs:> Mllegs];
(expr)//.{\[CapitalEpsilon][i_]-Modp[i_]/;MemberQ[Mslegs,i]:>m[i]^2/(2\[CapitalEpsilon][i]),\[CapitalEpsilon][i_]+Modp[i_]/;MemberQ[Mslegs,i]:>2 \[CapitalEpsilon][i]}//.{
...
SHAB[\[Mu]_,i_,\[Nu]_]/;MemberQ[Mslegs,i]:> SHAB[\[Mu],i//.sublegs,\[Nu]]+SHAA[\[Mu],\[Lambda][i,m]]SHBB[\[Nu],\[Lambda][i,p]],
...
SHBA[\[Mu]_,i_,\[Nu]_]/;MemberQ[Mslegs,i]:> SHBA[\[Mu],i//.sublegs,\[Nu]]+SHAA[\[Nu],\[Lambda][i,m]]SHBB[\[Mu],\[Lambda][i,p]]
}];
...
expr1=expr//DecomposetoSU2Basis[{i}]//SU2LGBasisComponent//SU2LRInnerProduct[{i}]//HighEnergyLimit[{i},{\[Lambda]1}];
